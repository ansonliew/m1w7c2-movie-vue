<template>
  ...
  <div class="card py-5 px-5">
    ...
    <div class="col-3">
      <button class="btn btn-primary btn-block" v-on:click="searchMovie" v-bind:disabled="isSearching"><span v-if="!isSearching">Search</span> <div class="spinner-border" role="status" v-if="isSearching">
  <span class="visually-hidden">Loading...</span>
    ...
    <table class="table table-striped table-bordered table-hover mt-5" v-if="movies.length > 0">
...
export default {
  ...
  methods: {
    searchMovie: function(){
      ...
      fetch('https://www.omdbapi.com/?s='+this.searchText+'&apikey=87d10179')
    ...
    selectMovie: function(movie){
      console.log(movie)
       fetch('https://www.omdbapi.com/?i='+movie.imdbID+'&apikey=87d10179')
            .then(response => response.json())
            .then(data => {
              console.log(data)
